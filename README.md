...
## Step 2: Star this [repo](https://github.com/hroland/Hacktoberfest-2019) and share it with your friends.
## Step 3: Just open "[index.html](https://github.com/hroland/Hacktoberfest-2019/blob/master/index.html)" and include your name and the link to your github profile in the "[li](https://github.com/hroland/Hacktoberfest-2019/blob/master/index.html)" tags to make a connection with all other open enthusiasts like us.
